...
/* Private defines -----------------------------------------------------------*/
#define KEY1_PAUSE_Pin GPIO_PIN_3
#define KEY1_PAUSE_GPIO_Port GPIOE
#define KEY0_RUN_Pin GPIO_PIN_4
#define KEY0_RUN_GPIO_Port GPIOE
#define KEY_Dir_Pin GPIO_PIN_0
